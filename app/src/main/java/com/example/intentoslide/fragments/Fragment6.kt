...
import kotlinx.android.synthetic.main.fragment_curiosidad.view.*
...
class Fragment6 : Fragment() {
    ...
    override fun onCreateView(
        ...
        val view = inflater.inflate(com.example.intentoslide.R.layout.fragment_curiosidad, container, false)
