...
import kotlinx.android.synthetic.main.fragment_enfermedad.view.*
...
class Fragment2 : Fragment() {
    ...
    override fun onCreateView(
        ...
        val view = inflater.inflate(com.example.intentoslide.R.layout.fragment_enfermedad, container, false)
